...
public class Neural_Window {
	...
	public void display_menu_for_net_selection(int NNnum) {
		...
		System.out.println();
		System.out
				.println("Please select one of the following network types from the Main Menu");
		int i = 0;
		do {
			System.out.println();
			i = i + 1;
		...
		System.out
				.println(" A.  Adaptive Resonance Theory network for binary signals ");
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Please enter the number of networks you wish to develop: ");
